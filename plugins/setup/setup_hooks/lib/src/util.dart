...
ProcessResult runCommand(
  ...
  _log.finer('Running: $executable ${redactBuildOutput(arguments.join(' '))}');
  if (environment != null && environment.isNotEmpty) {
    _log.finer('  env: ${redactBuildOutput(environment.toString())}');
  }
  ...
  if (out.isNotEmpty) _log.finest(redactBuildOutput(out));
  if (err.isNotEmpty) _log.finest(redactBuildOutput(err));
...
Future<void> runCommandStream(
  ...
  _log.info('exec: $executable ${redactBuildOutput(arguments.join(' '))}');
