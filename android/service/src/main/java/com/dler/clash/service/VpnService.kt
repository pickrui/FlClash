...
import com.dler.clash.common.AccessControlMode
import com.dler.clash.common.GlobalState
import com.dler.clash.core.Core
import com.dler.clash.service.models.VpnOptions
import com.dler.clash.service.models.getIpv4RouteAddress
import com.dler.clash.service.models.getIpv6RouteAddress
import com.dler.clash.service.models.toCIDR
...
class VpnService : SystemVpnService(), IBaseService,
    ...
    private fun handleStart(options: VpnOptions) {
        val fd = with(Builder()) {
            ...
            setSession("FlClash for Dler Cloud")
            setBlocking(false)
