...
@JsonKey(includeToJson: false) int? get id;@JsonKey(includeToJson: false) int? get profileId;@JsonKey(includeToJson: false) String? get order; String get name;@JsonKey(fromJson: GroupType.parseProfileType) GroupType get type;@JsonKey(fromJson: _parseStringList) List<String>? get proxies;@JsonKey(fromJson: _parseStringList) List<String>? get use;@JsonKey(fromJson: _parseInt) int? get interval;@JsonKey(fromJson: _parseInt) int? get tolerance;@JsonKey(fromJson: _parseBool) bool? get lazy;@JsonKey(name: 'disable-udp', fromJson: _parseBool) bool? get disableUdp; String? get url;@JsonKey(fromJson: _parseInt) int? get timeout;@JsonKey(name: 'max-failed-times', fromJson: _parseInt) int? get maxFailedTimes; String? get filter;@JsonKey(name: 'exclude-filter') String? get excludeFilter;@JsonKey(name: 'exclude-type') String? get excludeType;@JsonKey(name: 'expected-status') dynamic get expectedStatus;@JsonKey(name: 'include-all', fromJson: _parseBool) bool? get includeAll;@JsonKey(name: 'include-all-proxies', fromJson: _parseBool) bool? get includeAllProxies;@JsonKey(name: 'include-all-providers', fromJson: _parseBool) bool? get includeAllProviders; String? get strategy;@JsonKey(fromJson: _parseBool) bool? get hidden; String? get icon;
...
@useResult
$Res call({
@JsonKey(includeToJson: false) int? id,@JsonKey(includeToJson: false) int? profileId,@JsonKey(includeToJson: false) String? order, String name,@JsonKey(fromJson: GroupType.parseProfileType) GroupType type,@JsonKey(fromJson: _parseStringList) List<String>? proxies,@JsonKey(fromJson: _parseStringList) List<String>? use,@JsonKey(fromJson: _parseInt) int? interval,@JsonKey(fromJson: _parseInt) int? tolerance,@JsonKey(fromJson: _parseBool) bool? lazy,@JsonKey(name: 'disable-udp', fromJson: _parseBool) bool? disableUdp, String? url,@JsonKey(fromJson: _parseInt) int? timeout,@JsonKey(name: 'max-failed-times', fromJson: _parseInt) int? maxFailedTimes, String? filter,@JsonKey(name: 'exclude-filter') String? excludeFilter,@JsonKey(name: 'exclude-type') String? excludeType,@JsonKey(name: 'expected-status') dynamic expectedStatus,@JsonKey(name: 'include-all', fromJson: _parseBool) bool? includeAll,@JsonKey(name: 'include-all-proxies', fromJson: _parseBool) bool? includeAllProxies,@JsonKey(name: 'include-all-providers', fromJson: _parseBool) bool? includeAllProviders, String? strategy,@JsonKey(fromJson: _parseBool) bool? hidden, String? icon
});
...
as int?,tolerance: freezed == tolerance ? _self.tolerance : tolerance // ignore: cast_nullable_to_non_nullable
...
as dynamic,includeAll: freezed == includeAll ? _self.includeAll : includeAll // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  int? id, @JsonKey(includeToJson: false)  int? profileId, @JsonKey(includeToJson: false)  String? order,  String name, @JsonKey(fromJson: GroupType.parseProfileType)  GroupType type, @JsonKey(fromJson: _parseStringList)  List<String>? proxies, @JsonKey(fromJson: _parseStringList)  List<String>? use, @JsonKey(fromJson: _parseInt)  int? interval, @JsonKey(fromJson: _parseInt)  int? tolerance, @JsonKey(fromJson: _parseBool)  bool? lazy, @JsonKey(name: 'disable-udp', fromJson: _parseBool)  bool? disableUdp,  String? url, @JsonKey(fromJson: _parseInt)  int? timeout, @JsonKey(name: 'max-failed-times', fromJson: _parseInt)  int? maxFailedTimes,  String? filter, @JsonKey(name: 'exclude-filter')  String? excludeFilter, @JsonKey(name: 'exclude-type')  String? excludeType, @JsonKey(name: 'expected-status')  dynamic expectedStatus, @JsonKey(name: 'include-all', fromJson: _parseBool)  bool? includeAll, @JsonKey(name: 'include-all-proxies', fromJson: _parseBool)  bool? includeAllProxies, @JsonKey(name: 'include-all-providers', fromJson: _parseBool)  bool? includeAllProviders,  String? strategy, @JsonKey(fromJson: _parseBool)  bool? hidden,  String? icon)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProxyGroup() when $default != null:
return $default(_that.id,_that.profileId,_that.order,_that.name,_that.type,_that.proxies,_that.use,_that.interval,_that.tolerance,_that.lazy,_that.disableUdp,_that.url,_that.timeout,_that.maxFailedTimes,_that.filter,_that.excludeFilter,_that.excludeType,_that.expectedStatus,_that.includeAll,_that.includeAllProxies,_that.includeAllProviders,_that.strategy,_that.hidden,_that.icon);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  int? id, @JsonKey(includeToJson: false)  int? profileId, @JsonKey(includeToJson: false)  String? order,  String name, @JsonKey(fromJson: GroupType.parseProfileType)  GroupType type, @JsonKey(fromJson: _parseStringList)  List<String>? proxies, @JsonKey(fromJson: _parseStringList)  List<String>? use, @JsonKey(fromJson: _parseInt)  int? interval, @JsonKey(fromJson: _parseInt)  int? tolerance, @JsonKey(fromJson: _parseBool)  bool? lazy, @JsonKey(name: 'disable-udp', fromJson: _parseBool)  bool? disableUdp,  String? url, @JsonKey(fromJson: _parseInt)  int? timeout, @JsonKey(name: 'max-failed-times', fromJson: _parseInt)  int? maxFailedTimes,  String? filter, @JsonKey(name: 'exclude-filter')  String? excludeFilter, @JsonKey(name: 'exclude-type')  String? excludeType, @JsonKey(name: 'expected-status')  dynamic expectedStatus, @JsonKey(name: 'include-all', fromJson: _parseBool)  bool? includeAll, @JsonKey(name: 'include-all-proxies', fromJson: _parseBool)  bool? includeAllProxies, @JsonKey(name: 'include-all-providers', fromJson: _parseBool)  bool? includeAllProviders,  String? strategy, @JsonKey(fromJson: _parseBool)  bool? hidden,  String? icon)  $default,) {final _that = this;
switch (_that) {
case _ProxyGroup():
return $default(_that.id,_that.profileId,_that.order,_that.name,_that.type,_that.proxies,_that.use,_that.interval,_that.tolerance,_that.lazy,_that.disableUdp,_that.url,_that.timeout,_that.maxFailedTimes,_that.filter,_that.excludeFilter,_that.excludeType,_that.expectedStatus,_that.includeAll,_that.includeAllProxies,_that.includeAllProviders,_that.strategy,_that.hidden,_that.icon);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeToJson: false)  int? id, @JsonKey(includeToJson: false)  int? profileId, @JsonKey(includeToJson: false)  String? order,  String name, @JsonKey(fromJson: GroupType.parseProfileType)  GroupType type, @JsonKey(fromJson: _parseStringList)  List<String>? proxies, @JsonKey(fromJson: _parseStringList)  List<String>? use, @JsonKey(fromJson: _parseInt)  int? interval, @JsonKey(fromJson: _parseInt)  int? tolerance, @JsonKey(fromJson: _parseBool)  bool? lazy, @JsonKey(name: 'disable-udp', fromJson: _parseBool)  bool? disableUdp,  String? url, @JsonKey(fromJson: _parseInt)  int? timeout, @JsonKey(name: 'max-failed-times', fromJson: _parseInt)  int? maxFailedTimes,  String? filter, @JsonKey(name: 'exclude-filter')  String? excludeFilter, @JsonKey(name: 'exclude-type')  String? excludeType, @JsonKey(name: 'expected-status')  dynamic expectedStatus, @JsonKey(name: 'include-all', fromJson: _parseBool)  bool? includeAll, @JsonKey(name: 'include-all-proxies', fromJson: _parseBool)  bool? includeAllProxies, @JsonKey(name: 'include-all-providers', fromJson: _parseBool)  bool? includeAllProviders,  String? strategy, @JsonKey(fromJson: _parseBool)  bool? hidden,  String? icon)?  $default,) {final _that = this;
switch (_that) {
case _ProxyGroup() when $default != null:
return $default(_that.id,_that.profileId,_that.order,_that.name,_that.type,_that.proxies,_that.use,_that.interval,_that.tolerance,_that.lazy,_that.disableUdp,_that.url,_that.timeout,_that.maxFailedTimes,_that.filter,_that.excludeFilter,_that.excludeType,_that.expectedStatus,_that.includeAll,_that.includeAllProxies,_that.includeAllProviders,_that.strategy,_that.hidden,_that.icon);case _:
  return null;
...
@override@JsonKey(includeToJson: false) final  int? profileId;
@override@JsonKey(includeToJson: false) final  String? order;
...
@override@JsonKey(name: 'disable-udp', fromJson: _parseBool) final  bool? disableUdp;
...
@override@JsonKey(name: 'include-all', fromJson: _parseBool) final  bool? includeAll;
@override@JsonKey(name: 'include-all-proxies', fromJson: _parseBool) final  bool? includeAllProxies;
@override@JsonKey(name: 'include-all-providers', fromJson: _parseBool) final  bool? includeAllProviders;
...
/// Create a copy of ProxyGroup
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? profileId = freezed,Object? order = freezed,Object? name = null,Object? type = null,Object? proxies = freezed,Object? use = freezed,Object? interval = freezed,Object? tolerance = freezed,Object? lazy = freezed,Object? disableUdp = freezed,Object? url = freezed,Object? timeout = freezed,Object? maxFailedTimes = freezed,Object? filter = freezed,Object? excludeFilter = freezed,Object? excludeType = freezed,Object? expectedStatus = freezed,Object? includeAll = freezed,Object? includeAllProxies = freezed,Object? includeAllProviders = freezed,Object? strategy = freezed,Object? hidden = freezed,Object? icon = freezed,}) {
...
mixin _$Tun {
 ...
 bool get enable; String get device;@JsonKey(name: 'auto-route') bool get autoRoute; TunStack get stack;@JsonKey(fromJson: normalizeTunMtu) int get mtu;@JsonKey(name: 'dns-hijack') List<String> get dnsHijack;@JsonKey(name: 'route-address') List<String> get routeAddress;
...
@useResult
$Res call({
 bool enable, String device,@JsonKey(name: 'auto-route') bool autoRoute, TunStack stack,@JsonKey(fromJson: normalizeTunMtu) int mtu,@JsonKey(name: 'dns-hijack') List<String> dnsHijack,@JsonKey(name: 'route-address') List<String> routeAddress
});
...
as int,dnsHijack: null == dnsHijack ? _self.dnsHijack : dnsHijack // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enable,  String device, @JsonKey(name: 'auto-route')  bool autoRoute,  TunStack stack, @JsonKey(fromJson: normalizeTunMtu)  int mtu, @JsonKey(name: 'dns-hijack')  List<String> dnsHijack, @JsonKey(name: 'route-address')  List<String> routeAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tun() when $default != null:
return $default(_that.enable,_that.device,_that.autoRoute,_that.stack,_that.mtu,_that.dnsHijack,_that.routeAddress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enable,  String device, @JsonKey(name: 'auto-route')  bool autoRoute,  TunStack stack, @JsonKey(fromJson: normalizeTunMtu)  int mtu, @JsonKey(name: 'dns-hijack')  List<String> dnsHijack, @JsonKey(name: 'route-address')  List<String> routeAddress)  $default,) {final _that = this;
switch (_that) {
case _Tun():
return $default(_that.enable,_that.device,_that.autoRoute,_that.stack,_that.mtu,_that.dnsHijack,_that.routeAddress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enable,  String device, @JsonKey(name: 'auto-route')  bool autoRoute,  TunStack stack, @JsonKey(fromJson: normalizeTunMtu)  int mtu, @JsonKey(name: 'dns-hijack')  List<String> dnsHijack, @JsonKey(name: 'route-address')  List<String> routeAddress)?  $default,) {final _that = this;
switch (_that) {
case _Tun() when $default != null:
return $default(_that.enable,_that.device,_that.autoRoute,_that.stack,_that.mtu,_that.dnsHijack,_that.routeAddress);case _:
  return null;
...
/// Create a copy of Tun
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enable = null,Object? device = null,Object? autoRoute = null,Object? stack = null,Object? mtu = null,Object? dnsHijack = null,Object? routeAddress = null,}) {
  return _then(_Tun(
enable: null == enable ? _self.enable : enable // ignore: cast_nullable_to_non_nullable
as bool,device: null == device ? _self.device : device // ignore: cast_nullable_to_non_nullable
as String,autoRoute: null == autoRoute ? _self.autoRoute : autoRoute // ignore: cast_nullable_to_non_nullable
as bool,stack: null == stack ? _self.stack : stack // ignore: cast_nullable_to_non_nullable
as TunStack,mtu: null == mtu ? _self.mtu : mtu // ignore: cast_nullable_to_non_nullable
as int,dnsHijack: null == dnsHijack ? _self._dnsHijack : dnsHijack // ignore: cast_nullable_to_non_nullable
...
class _GeoXUrl implements GeoXUrl {
  const _GeoXUrl({this.mmdb = 'https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geoip.metadb', this.asn = 'https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/GeoLite2-ASN.mmdb', this.geoip = 'https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geoip.dat', this.geosite = 'https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geosite.dat'});
...
as ExternalControllerStatus,externalControllerAddress: null == externalControllerAddress ? _self.externalControllerAddress : externalControllerAddress // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'external-controller-address') final  String externalControllerAddress;
